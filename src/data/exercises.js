export const CATEGORIES = ["Upper Body Push", "Upper Body Pull", "Lower Body", "Core", "Cardio"];
...
export const EXERCISES = [
  ...
  { id: "hack_squat", name: "Hack Squat", category: "Lower Body", muscles: ["Quads", "Glutes"] },
  {
    ...
    name: "Sumo Deadlift",
    category: "Lower Body",
    muscles: ["Glutes", "Inner Thighs", "Hamstrings"],
  },
  ...
  // -- Core --
  {
    ...
    name: "Plank",
    category: "Core",
    muscles: ["Abs", "Transverse Abdominis", "Shoulders"],
  },
  ...
  { id: "cycling", name: "Cycling", category: "Cardio", muscles: ["Cardiovascular", "Legs"] },
  {
    ...
    name: "Rowing Machine",
    category: "Cardio",
    muscles: ["Cardiovascular", "Back", "Arms"],
  },
  {
    id: "elliptical",
    name: "Elliptical",
  ...
  { id: "jump_rope", name: "Jump Rope", category: "Cardio", muscles: ["Cardiovascular", "Calves"] },
  {
    ...
    name: "Stair Climber",
    category: "Cardio",
    muscles: ["Cardiovascular", "Glutes", "Legs"],
  },
  {
    id: "swimming",
    name: "Swimming",
  ...
  },
  {
    ...
    name: "Battle Ropes",
    category: "Cardio",
    muscles: ["Cardiovascular", "Shoulders", "Arms"],
  },
  {
    id: "sprints",
