...
export default function Water() {
  ...
  const addError =
    ...
    "";
  const goalError =
    goalClientError || (updateGoalsMutation.error && updateGoalsMutation.error.message) || "";
  ...
  function handleSaveWaterGoal() {
    ...
    if (!n || n <= 0) {
      setGoalClientError("Enter a valid goal.");
      return;
    }
    setGoalClientError("");
  ...
  function handleCustomAdd() {
    ...
    if (!n || n <= 0) {
      setAddClientError("Enter a valid amount.");
      return;
    }
    setCustomAmt("");
    handleAdd(n);
      ...
      <Card className="bg-sky-500/10 ring-sky-500/20">
        <CardContent className="space-y-2">
          ...
          <div className="text-center my-2">
            ...
            <p className="text-base text-sky-500/80 mt-1 font-medium">
              oz &nbsp;·&nbsp; {cups} cups
            </p>
          </div>
